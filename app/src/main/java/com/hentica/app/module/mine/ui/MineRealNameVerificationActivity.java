...
public class MineRealNameVerificationActivity extends BaseCompatActivity implements RealNameVerificationView{
    ...
    @Override
    public void verificationSuccess(String data) {
        showToast("认证完成");
    }
}
