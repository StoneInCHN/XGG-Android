 ...
 */
public class MineFillEvaluateFragment extends BaseFragment {
    ...
    private void refreshSellerInfo(ResMineOrderListData.SellerBean seller) {
        if (seller != null) {
            ViewUtil.bindImage(getView(), R.id.mine_fill_value_icon, ApplicationData.getInstance().getImageUrl(seller.getStorePictureUrl()));
                ...
                ListenerAdapter.createObjectListener(Object.class, new UsualDataBackListener<Object>(this) {
                    ...
                    protected void onComplete(boolean isSuccess, Object data) {
                        if (isSuccess) {
                            ...
                            FragmentJumpUtil.toEvaluateDetail(getUsualFragment(), mOrderInfo);
                            // 发送评论成功通知
