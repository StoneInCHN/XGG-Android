...
public class DragGridView extends GridView {
	...
	private Runnable mLongClickRunnable = new Runnable() {
		...
		public void run() {
			...
			// 若不可拖拽，则放弃
			if (dragControler != null && !dragControler.canStartDrag(mDragPosition)) {
			...
			if (onChanageListener != null) {
				...
				onChanageListener.onDragStart(mDragPosition);
			}
		}
	};

	/** 设置拖拽控制 */
	public void setDragControler(DragControler dragControler) {

		this.dragControler = dragControler;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		return isDrag ? false : super.onInterceptTouchEvent(ev);
	}
	...
	private void onSwapItem(int moveX, int moveY) {
		...
		// 若不允许交换，则停止
		if (dragControler != null && !dragControler.caSwap(mDragPosition, tempPosition)) {
		...
		if (onChanageListener != null) {
			...
			onChanageListener.onMove(mDragPosition, moveX, moveY);
		}
	...
	/** 拖拽过程控制 */
	public interface DragControler {

		public boolean canStartDrag(int position);

		public boolean caSwap(int from, int to);
	}
	...
	public interface OnChanageListener {
		 ...
		 *            竖直坐标
		 */
		public void onMove(int position, int x, int y);
