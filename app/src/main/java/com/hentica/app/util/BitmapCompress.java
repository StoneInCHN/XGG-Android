...
public class BitmapCompress {
    ...
    private static final String TAG = BitmapCompress.class.getSimpleName();
    ...
    public static int getSampleSize(int[] sizes) {
        ...
        LogUtils.i(TAG, "sampleSize：" + sampleSize);
        return sampleSize;
    }
    ...
    public static void bitmapToFile(Bitmap bitmap, String outFile) {
        ...
        try {
            ...
            bos.flush();
            LogUtils.i(TAG, "compress bitmap to file success!");
