...
public class FasterAnimationsContainer {
    ...
    private boolean mShouldRun; // true if the animation should continue running. Used to playStop the animation
    ...
    /**
     * set a wrapListener for OnAnimationStoppedListener
     *
    ...
    /**
     * set a wrapListener for OnAnimationFrameChangedListener
     *
