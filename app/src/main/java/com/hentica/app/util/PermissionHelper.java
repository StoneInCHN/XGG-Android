...
//            Toast.makeText(fragment.getContext(), "opened:" + requestPermissions[requestCode], Toast.LENGTH_SHORT).show();
    ...
    private static void requestMultiResult(Fragment fragment, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
...
//                    .show();
     ...
     * 一次申请多个权限
     */
    public static void requestMultiPermissions(final Fragment fragment, PermissionGrant grant) {
    ...
    protected static void showMessageOKCancel(FragmentManager fm, String message, View.OnClickListener l){
        SelfAlertDialogHelper.showDialog(fm, message, "去设置", "暂不", l);
    }
